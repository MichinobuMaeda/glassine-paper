 ...
 * />
 */
export const TextField = ({ id, name, variant = 'outlined', type = 'text', label = '', value, lineCount = 1, error = false, readonly = false, disabled = false, supportingText, leadingIcon, trailingIcon, onChange, onBlur, onFocus, className = '', style = {}, innerStyle = {}, }) => {
