 ...
 * />
 */
export const TextField = ({ id, name, variant = 'outlined', type = 'text', label = '', value, lineCount = 1, readonly = false, disabled = false, supportingText, errorMessage, error = false, leadingIcon, trailingIcon, onChange, onBlur, onFocus, className = '', style = {}, innerStyle = {}, }) => {
    const classes = [
        'textfield',
        variant,
        ...
        .filter(Boolean)
        .join(' ');
    supportingText = errorMessage ? errorMessage : supportingText;
    return (_jsxs("div", { className: classes, style: style, children: [leadingIcon && leadingIcon, _jsx("label", { children: label }), lineCount > 1 ? (_jsx("textarea", { id: id, name: name, value: value, placeholder: label, readOnly: readonly, disabled: disabled, onChange: onChange, onBlur: onBlur, onFocus: onFocus, style: innerStyle, rows: lineCount })) : (_jsx("input", { id: id, name: name, type: type, value: value, placeholder: label, readOnly: readonly, disabled: disabled, onChange: onChange, onBlur: onBlur, onFocus: onFocus, style: innerStyle })), trailingIcon && trailingIcon, supportingText && _jsx("div", { children: supportingText })] }));
};
