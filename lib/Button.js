...
export const Button = ({ id, name, variant = 'filled', size = 'md', icon = false, width = 'default', radius = 'default', type = 'button', href, checked = false, disabled = false, children, onClick, className = '', }) => {
    const classes = [
        ...
        .filter(Boolean)
        .join(' ');
    return type === 'toggle' ? (_jsxs("label", { id: `${id}-label`, className: classes, children: [_jsx("input", { id: id, name: name, type: "checkbox", checked: checked, onClick: (event) => (onClick ? onClick(event) : undefined) }), children] })) : type === 'select' ? (_jsxs("label", { id: `${id}-label`, className: classes, children: [_jsx("input", { id: id, name: name, type: "radio", checked: checked, onClick: (event) => (onClick ? onClick(event) : undefined) }), children] })) : href ? (_jsx("a", { id: id, href: href, className: classes, children: children })) : (_jsx("button", { id: id, name: name, type: type, className: classes, disabled: disabled, onClick: onClick, children: children }));
};
