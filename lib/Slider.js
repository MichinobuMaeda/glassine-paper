 ...
 * />
 */
export const Slider = ({ id, name, min = 0, max = 100, step = 1, value, displayValue, size = 'sm', orientation = 'horizontal', showValueIndicator = false, options = [], onChange, className = '', style = {}, }) => {
