# API Documentation glassine-paper 1.2.3
...
```js
// Icon button
<Button variant="outlined" icon width="wide" icon={<svg>...</svg>} />
```
...
```js
// Link button
<Button variant="elevated" href="https://example.com" label="Go to Example" />
```
